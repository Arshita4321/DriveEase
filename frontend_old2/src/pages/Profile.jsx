...
import { FiUser, FiPhone, FiMail, FiCamera, FiSave, FiHeart, FiTrendingUp } from 'react-icons/fi';
  ...
  return (
    <div className="container-px mx-auto max-w-5xl py-10">
      ...
      <div className="mt-8 flex gap-2 border-b border-primary-100 dark:border-white/10">
        {[{ id: 'profile', label: 'Profile' }, { id: 'wishlist', label: `Wishlist (${wishlist.length})` }].map((t) => (
          <button
            key={t.id}
            onClick={() => setTab(t.id)}
