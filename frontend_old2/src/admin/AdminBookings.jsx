                ...
                <tr key={b._id} className="border-b border-primary-50 last:border-0 hover:bg-primary-50/50 dark:border-white/5 dark:hover:bg-white/[0.03]">
                  ...
                  <td className="px-4 py-3">
                    <select
                      ...
                      className="rounded-lg border border-primary-100 bg-white/80 px-2.5 py-1.5 text-xs font-medium capitalize outline-none dark:border-white/10 dark:bg-white/5 dark:text-white"
                    >
